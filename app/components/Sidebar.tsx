...
export default function Sidebar({
  ...
  return (
    <>
      ...
      <aside
        ref={sidebarRef}
        className={`fixed left-0 top-0 z-50 h-full w-64 border-r border-sidebar-border bg-sidebar text-sidebar-foreground shadow-lg transition-transform lg:relative lg:z-auto lg:shadow-none lg:translate-x-0 ${isMobileOpen ? "translate-x-0" : "-translate-x-full lg:translate-x-0"
          }`}
      >
        <nav className="flex h-full flex-col p-2" aria-label="Navigation">
          {/* Header with close button on mobile */}
          <div className="mb-2 flex items-center justify-between border-b border-border pb-2 lg:border-0 lg:pb-0">
          ...
          <div className="mt-2 flex-1 overflow-y-auto">
            <p className="px-3 py-1 text-xs font-medium text-muted-foreground">My Storages</p>
